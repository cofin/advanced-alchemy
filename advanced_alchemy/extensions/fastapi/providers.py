...
# ============================================================================
# provide_async_services — out-of-DI service composition (background, scripts)
# ============================================================================
...
async def provide_async_services(
    *inputs: "SQLAlchemyAsyncServiceCompositionInput[Any]",
    ...
    """Compose and open services in one call — FastAPI-aware.
    ...
    Args:
        *inputs: Service classes or provider generators.
        ...
        request: An optional FastAPI request to resolve the session from.
    ...
    if session is not None:
        ...
        if sess is None:
            msg = f"No session in request.state.{config.session_key} — ensure the FastAPI extension's middleware is registered"
